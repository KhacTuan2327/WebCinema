      ...
      <div class="footer">
        <div class="footer-top">
          ...
          <ul class="social-list">
            ...
            <li class="social-item">
              <a href="https://twiter.com" title="Twiter" class="social-link">
                <svg
                  width="24"
                  height="25"
                  viewBox="0 0 24 25"
        ...
        <div class="footer-body">
          ...
          <div class="category-wrap">
            ...
            <ul class="category-list">
              ...
              <li class="category-item">
                <a href="#" title="Phim hoạt hình" class="category-link">
                  Phim hoạt hình
                </a>
              </li>
              <li class="category-item">
          ...
          <div class="category-wrap">
            ...
            <ul class="category-list">
              ...
              <li class="category-item">
                <a href="#" title="Tp.Hồ Chí Minh" class="category-link">
                  Tp.Hồ Chí Minh
                </a>
              </li>
            </ul>
